...
void testBench(void) {
    ...
    TestCase tests[] = {
		...
		{"LUI $t0, #43981",     "0011 1100 0000 1000 1010 1011 1100 1101", "0x3c08abcd"},
		...
		{"MFLO $t0, $t1, $t2",   "0000 0000 0000 0000 0100 0000 0001 0010", "0x04012"},
		...
		{"ANDI $t0, $t1, #255", "0011 0001 0010 1000 0000 0000 1111 1111", "0x312800ff"},
		...
		{"SUB $t0, $t1, $t2",    "0000 0001 0010 1010 0100 0000 0010 0010", "0x012a4022"}, 
		{"AND $v0, $v1, $a0", "0000 0000 0110 0100 0001 0000 0010 0100", "0x0641024"},
		...
		{"ORI $t2, $t3, #1023", "0011 0101 0110 1010 0000 0011 1111 1111", "0x356a03ff"},
		// Logical Operations
		{"AND $v0, $v1, $a0", "0000 0000 0110 0100 0001 0000 0010 0100", "0x0641024"},
		{"ANDI $t7, $t8, #4095", "0011 0011 0000 1111 0000 1111 1111 1111", "0x330f0fff"},
		{"OR $a1, $a2, $a3", "0000 0000 1100 0111 0010 1000 0010 0101", "0x0c72825"},
		{"ORI $t9, $t0, #127", "0011 0101 0001 1001 0000 0000 0111 1111", "0x3519007f"},
		...
		{"MULT $a0, $a1, $a2", "0000 0000 1000 0101 0000 0000 0001 1000", "0x0850018"},
